...
const steps = [
  {
    ...
    subtitle: "Define",
    description: "We begin by understanding your business, operational challenges, and goals to identify opportunities where technology can deliver meaningful value.",
  ...
  },
  {
    ...
    subtitle: "the task",
    description: "We combine software engineering, AI, automation, and data-driven technologies to create solutions tailored to your requirements.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                A delivery method built for the AI era, not adapted from the past.
              </p>
          </div>
